...
// ParticlesJS Config start.............


  // ParticlesJS Config end.............
$('#top').click(function(){
    $("html, body").animate({scrollTop:0},1000)
    return false
})
let tops  = document.getElementById('top') 
let sms_img = document.getElementById('sms-img')
window.onscroll=()=>{
 
  if(window.scrollY > 400){
     tops.classList.add("top-1")
     sms_img.classList.add('sms-img-tranzition')
  }
  else if(window.scrollY < 400){
     tops.classList.remove("top-1")
     sms_img.classList.remove('sms-img-tranzition')
  }
}
...
let armenia_1_320 = document.getElementById('armenia-1-320')
 armenia_1_320.onclick = function() {
	...
	document.getElementById('oll-sections').classList.toggle('oll-sections-white')
	  if(toggle === true){
		armenia_1_320.src = '../image/dark-font.svg'
		  document.getElementById('qr-code').src = '../image/Group (1).png'
	  
	  }
	  else{
		  document.getElementById('qr-code').src = '../image/qr-cod-black.svg'
...
let coll_2 = document.getElementById('coll-2')

coll_2.onclick = function () {
  document.getElementById('cool-registration').classList.toggle('cool-registration-on')
  document.getElementById('signup_4').classList.remove('signup-block-onclick')
  document.getElementById('search').classList.remove('search-hover')
}
